...
<body>
    ...
    /> 
				...
				<div class="row mb-2">
					<div class="col-md-6">
						<label for="nome"> Nome do Contato:</label> <input type="text"
							class="form-control" id="nome" name="nome_contato"
					...
					<div class="col-md-3">
						<label for="email">Email:</label> <input type="email"class="form-control" id="email" name="email_contato" placeholder="Digite o endereço de  email" required="required" title="Por favor, informe um  endereço de email válido."
						value="${contato.email}" />
					</div>
