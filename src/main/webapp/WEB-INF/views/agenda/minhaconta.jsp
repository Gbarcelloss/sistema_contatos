...
<body>
	...
	<div class="card m-4">
		<div class="card-body">
			...
			<p>Utilize o formulário abaixo para alterar sua senha de acesso:
			</p>
	...
	<form method="post" action="alterar-senha">
      ...
      <h4>${mensagem_erro}</h4>     
				...
				<div class="row mb-2">
					...
					<div class="col-md-3">
						<label>Informe a senha atual:</label> <input type="password" name="senhaAtual" class="form-control" required="required" />
					</div>

					<div class="col-md-3">
						<label>Informe a nova senha:</label> <input type="password"
							name="novaSenha" class="form-control" required="required"
							pattern="(?=.*\d)(?=.*[a-z])(?=.*[AZ])(?=.*[!@#$%^&*]).{8,}"
				...
				<div class="row mb-2">
					<div class="col-md-12">
						<input type="submit" class="btn btn-success" value="Redefinir Senha" />
					</div>
				</div>
